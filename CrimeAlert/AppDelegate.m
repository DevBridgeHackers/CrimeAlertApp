                      ...
                      error:(NSError *)error
{
    switch (state) {
        case FBSessionStateOpen: {
            NSLog(@"session.accessToken=%@ lenght=%i",session.accessToken,[session.accessToken length]);
            [[NSNotificationCenter defaultCenter] postNotificationName:@"facebook_connected" object:nil];
